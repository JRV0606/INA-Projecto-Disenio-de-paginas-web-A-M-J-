...
function renderizarDetalle() {
  ...
  /*
        ...
        nada al abrir el chat.

        "encodeURIComponent" convierte un texto normal en un
        formato seguro para viajar dentro de una URL (por
        ejemplo, cambia los espacios por %20 y los acentos por
        su codigo correspondiente). Es necesario porque el
        texto del mensaje puede tener espacios, comas y tildes,
        y esos caracteres no se pueden poner tal cual en una URL.

        El numero de WhatsApp del negocio es fijo (siempre el
        mismo), asi que va escrito directo en el codigo, sin
